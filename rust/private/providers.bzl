...
DepInfo = provider(
    ...
    fields = {
        ...
        "transitive_crate_outputs": "depset[File]: All transitive crate outputs, excluding those from proc-macro dep chains.",
        "transitive_proc_macro_dep_outputs": "depset[File]: Transitive crate outputs from proc-macro deps. Required as action inputs for proc-macro link actions because rustc passes all transitively-reachable rlibs to the linker.",
